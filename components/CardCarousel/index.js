...
import { View, ScrollView, Text, StatusBar, Platform, Button } from 'react-native';
    ...
    get example0 () {
        ...
        return (
            <View style={styles.exampleContainer}>
                ...
                <Text style={styles.subtitle}>je choisis l'émotion limitante que je veux libérer</Text>
