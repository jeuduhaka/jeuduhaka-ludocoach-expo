export default {
  ...
  gifts: {
    en: {
      amour: require('../assets/images/giftcards/en/carte-cadeau-amour.jpg'),
      calme: require('../assets/images/giftcards/en/carte-cadeau-calme.jpg'),
      confiance: require('../assets/images/giftcards/en/carte-cadeau-confiance.jpg'),
      energie: require('../assets/images/giftcards/en/carte-cadeau-energie.jpg'),
      'estime-de-soi': require('../assets/images/giftcards/en/carte-cadeau-estime-de-soi.jpg'),
      force: require('../assets/images/giftcards/en/carte-cadeau-force.jpg'),
      joie: require('../assets/images/giftcards/en/carte-cadeau-joie.jpg'),
      paix: require('../assets/images/giftcards/en/carte-cadeau-paix.jpg'),
    },
    fr: {
      amour: require('../assets/images/giftcards/fr/carte-cadeau-amour.jpg'),
      calme: require('../assets/images/giftcards/fr/carte-cadeau-calme.jpg'),
      confiance: require('../assets/images/giftcards/fr/carte-cadeau-confiance.jpg'),
      energie: require('../assets/images/giftcards/fr/carte-cadeau-energie.jpg'),
      'estime-de-soi': require('../assets/images/giftcards/fr/carte-cadeau-estime-de-soi.jpg'),
      force: require('../assets/images/giftcards/fr/carte-cadeau-force.jpg'),
      joie: require('../assets/images/giftcards/fr/carte-cadeau-joie.jpg'),
      paix: require('../assets/images/giftcards/fr/carte-cadeau-paix.jpg'),
    },
  },
  back: {
